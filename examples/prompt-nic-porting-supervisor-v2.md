...
> **Stack:** Uses the 8-layer stack from `framework-comparison-v4-compact.md`.
> **Dual Orchestrator:** This prompt drives the CORE orchestrator (ClawTeam).
> The SECONDARY orchestrator (Agent Orchestrator) handles CI/PR feedback and dashboard.
> **Default coding agent:** Aider (Tier 1). See three-tier agent model in compact reference.
